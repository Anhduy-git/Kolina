...
import com.example.recipeapp.databinding.ItemMaterialAddLayoutGetBinding

class CustomViewListMaterialAdapterGet(
    private val context: Context
) : RecyclerView.Adapter<CustomViewListMaterialAdapterGet.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        return MyViewHolder(ItemMaterialAddLayoutGetBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
     ...
     */
    class MyViewHolder(var binding: ItemMaterialAddLayoutGetBinding) : RecyclerView.ViewHolder(binding.root) {
