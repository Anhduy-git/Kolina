...
class MaterialDishFragment : Fragment() {
    private var _binding: FragmentMaterialDishBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMaterialDishBinding.inflate(inflater, container, false)
